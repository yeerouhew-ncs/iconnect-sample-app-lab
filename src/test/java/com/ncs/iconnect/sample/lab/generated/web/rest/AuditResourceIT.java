...
import com.ncs.itrust5.ss5.repository.PAuditEventRepository;
...
public class AuditResourceIT {
	...
	@Autowired
	private PAuditEventRepository pauditEventRepository;
    ...
    public void setup() {
        ...
        AuditEventService auditEventService =
            new AuditEventService(auditEventRepository, pauditEventRepository, auditEventConverter);
    ...
    public void searchRevision() throws Exception {
    	...
    	restAuditMockMvc.perform(get("/management/audits?fromDate="+fromDate+"&toDate="+toDate+"&user="+user+"&event=" + event))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON));
    }
}

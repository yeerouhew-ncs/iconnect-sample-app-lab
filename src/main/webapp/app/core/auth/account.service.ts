...
export class AccountService {
  ...
  getMenus(): any {
    return this.isIdentityResolved() && null !== this.userIdentity ? this.userIdentity.menus : null;
  }

  getMenusStyle(): any {
    return this.isIdentityResolved() && null !== this.userIdentity ? this.userIdentity.menusStyle : null;
  }
